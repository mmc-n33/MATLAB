% Code belongs to Chalmer's University's Mcmaster Program: Emerging Automotive Technologies

classdef MeasureModel
    %MEASUREMODEL is a class containing different measurement models
